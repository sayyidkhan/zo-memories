...
- Private destination-specific social exports: adaptive JPEG story carousels that grow with the photo count and retain overflow in editorial collages, plus H.264 MP4 stories for video placements, with immediate local preview, background persistence, and multi-file native device sharing
