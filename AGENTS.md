...
- Social exports preserve the selected story style but create a distinct reusable master for each destination and placement. Dimensions, safe areas, pacing, crop intensity, photo count, and video bitrate adapt to Instagram, Facebook, TikTok, YouTube Shorts, LinkedIn, X, Threads, Pinterest, WhatsApp, or Snapchat. Exports remain private to shared-space members, support destination-triggered download plus native device sharing, and are deleted with their story.
