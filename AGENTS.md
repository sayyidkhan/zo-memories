...
- Motion exports include Ken Burns movement and a subtle procedurally generated ambient bed. The soundtrack is generated in-browser, so it adds no third-party asset or licensing dependency; previews start muted and can be unmuted deliberately.
