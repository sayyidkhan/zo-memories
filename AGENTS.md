...
- Social exports render the selected story style into reusable feed (`1080x1350` PNG), Pinterest (`1000x1500` PNG), or vertical (`1080x1920` H.264 MP4) masters. They remain private to shared-space members, support destination-labelled download plus native device sharing, and are deleted with their story.
