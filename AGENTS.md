...
- Story creators and space owners can edit a story's title, place, opening, selected moments, and presentation style. Editing retains the story identity and creation metadata but clears generated social exports so they must be regenerated from the current content.
